...
def mann_whitney_plus_means(turnstile_weather):
    ...
    '''
    x = turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain']==1].values
    y = turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain']==0].values
    with_rain_mean, without_rain_mean = np.mean(x), np.mean(y)
